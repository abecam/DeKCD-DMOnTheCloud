...
graph TD
  ...
  %% Styles
  classDef infra fill:#326ce5,color:#fff,stroke:#1b3c87
  classDef workload fill:#4f8cff,color:#fff,stroke:#1b3c87
  classDef config fill:#5bb974,color:#fff,stroke:#2f6f44
  classDef tool fill:#7b6cf6,color:#fff,stroke:#3b2fa3

  class Cluster,Node infra
  class Deployment,ReplicaSet,DaemonSet,StatefulSet,Job,Pod workload
  class Service,ConfigMap,Secret,Label config
  class Manifest,kubectl tool
```
