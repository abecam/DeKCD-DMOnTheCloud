...
* Attack via vulnerability or 
* Denial of Service/Brute Force attack. Sometime, and attacker just want to disrupt a service, or break it in order to obtain something (like logging in or accessing a database). While a break-in is often the result of exploiting a vulnerability, such as a zero-day vulnerability: a security hole, maybe due to an unknown bug, 
